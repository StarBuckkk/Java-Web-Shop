...
public class JsonServlet2 extends HttpServlet {
	...
	private void doHandle(HttpServletRequest request, HttpServletResponse response)
		...
		JSONArray membersArray = new JSONArray(); // memberInfo json 객체를 저장할 membersArray 배열 선언
		JSONObject memberInfo = new JSONObject(); // 회원 한 명의 정보가 들어갈 memberinfo json 객체 선언

		memberInfo.put("name", "박지성"); // 회원 정보를 name / value 쌍으로 저장
		...
		memberInfo = new JSONObject(); // 다른 회원 정보를 name / value 쌍으로 저장 한 후 membersArray에 다시 저장
